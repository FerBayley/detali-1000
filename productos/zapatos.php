		...
		<?php include("public/includes/header.php"); ?>
			<section class="Columnas">
				...
				<div class="Columnas-2">
					<img data-src="public/images/zapato1.jpg" alt="Zapatos cuero y gamuza">
					<h2 class="Columnas-titulo">ZAPATO COCODRILO MARRON</h2>
					<h3 class="Columnas-precio">PRECIO AR$--- - <a href="#">VER MAS</a></h3>


					<img data-src="public/images/zapato9.jpg" alt="Zapatos cuero y gamuza">
					<h2 class="Columnas-titulo">ZAPATO COCODRILO MARRON</h2>
					<h3 class="Columnas-precio">PRECIO AR$--- - <a href="#">VER MAS</a></h3>
				</div> <!-- / Columnas-2 -->

				<div class="Columnas-3">
					<img data-src="public/images/zapato10.jpg" alt="Zapatos cuero y gamuza">
					<h2 class="Columnas-titulo">ZAPATO CUERO MARRON</h2>
					<h3 class="Columnas-precio">PRECIO AR$--- - <a href="#">VER MAS</a></h3>


					<img data-src="public/images/zapato16.jpg" alt="Zapatos cuero y gamuza">
					<h2 class="Columnas-titulo">ZAPATO COCODRILO MARRON</h2>
					<h3 class="Columnas-precio">PRECIO AR$--- - <a href="#">VER MAS</a></h3>
				</div> <!-- / Columnas-3 -->

				<div class="Columnas-4">
					<img data-src="public/images/zapato13.jpg" alt="Zapatos cuero y gamuza">
					<h2 class="Columnas-titulo">ZAPATO GAMUZA AZUL</h2>
					<h3 class="Columnas-precio">PRECIO AR$--- - <a href="#">VER MAS</a></h3>
				</div> <!-- / Columnas-4 -->
			</section> <!-- / Columnas -->
